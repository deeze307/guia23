...
<body>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="inner_banner_detail">
                        <h2 align="right">Rio Grande</h2>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                    <div class="inner_banner_detail">
                        <p><a href="../Index-tdf.php"> Inicio  </a> <i class="fa fa-angle-double-right" aria-hidden="true"></i>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- Inner Banner -->
     ...
     <?php require "partials/banner-ushu.php";?>
     <!-- Popular Listing -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="best-thing-slider" class="owl-carousel owl-theme">
                            <div class="item">
                                <img src="images/20151107_131405.jpg" alt="image">
                            </div>
                            <div class="item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="best-thing-model-feature">
                                    <h4>Categorias</h4>
                                    <ul>
                                        <li>Restaurantes (46)</li>
                                        <li>Hoteles (66)</li>
                                        <li>Turismo (25)</li>
                                        <li>Deportes (16)</li>
                                        <li>Profesionales (28)</li>
                                        <li>Hogar (26)</li>
