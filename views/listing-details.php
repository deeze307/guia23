...
<head>
    ...
    <meta name="Imagenes de Paisajes, puntos de interes turisticos, Tierra del Fuego, Santa Cruz, Chubut, Neuquen">
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
    <title>Guia23-Detalles de publicaciones</title>
                    ...
                    <div id="least">
                        <div class="least-preview"></div>
                            ...
                            <ul class="least-gallery">
                                ...
                                if(isset($adv_detail->commercial_image) && ($adv_detail->commercial_image != '' && $adv_detail->commercial_image != 'vacio'))
                                {
