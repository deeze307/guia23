...
$adv_commerce = new AdvertsingsCommerceController();
$commerces = $adv_commerce->getCommercesForUserId($_SESSION['user_id']);
...
{
    $plan = $adv->getOnePlan($_COOKIE["PLAN"]);
}
//else {
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                ...
                                <div class="listing-title-area">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="titulo" class="form-control" placeholder="Ingrese el Titulo de su publicidad para que se vea en todo el mundo." value="<?php if(isset($adv_data->title)){echo $adv_data->title;} ?>" required>
                                    </div>
                                ...
                                <div class="listing-title-area">
                                    ...
                                    <div class="form-group">
                                        <label><span>Comercio </span>
                                        </label>
                                        <div class="single-query form-group">
                                            <div class="intro">
                                                <select id="comercio" name="comercio" class="form-control" required>
                                                    <option class="active" value="">Seleccione su Comercio...</option>
                                                    <?php
                                                        foreach($commerces as $commerce) {
                                                            echo "<option value='".$commerce->id."' selected='selected'>".$commerce->commerce_name."</option>";
                                                        }
                                                    ?>
                                                </select>
                                            </div>
...
<!--                                </div>-->
                                <div class="listing-title-area">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" name="precio" class="form-control" placeholder="Ponga su Precio" value="'. if(isset($adv_data->price)){echo $adv_data->price;} ?>">
                                    </div>

                                </div>

                                <?php
                                    if(isset($plan) && $plan->admin == 1)
                                    {
                                        echo '
                                            <div class="listing-title-area">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="direccion" class="form-control" placeholder="Escriba su direccion Comercial..." value="'.((isset($adv_data->address)) ? $adv_data->address : "") .'">
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="latitud" id="latitud" class="form-control" placeholder="-54.792645" value="'.((isset($adv_data->latitude)) ? $adv_data->latitude : "") .'">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="longitud" id="longitud" class="form-control" placeholder="-68.231501" value="'.((isset($adv_data->longitude)) ? $adv_data->longitude : "") .'">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="addressbox" data-office="free">
                                                ...
                                                <ul class="packg-detail">
                                                    <li><i class="fa fa-check-square-o" aria-hidden="true"></i>
                                                        Duración: <?php echo $plan->duration;
                                                        if ($plan->duration > 2) {
                                                            echo " Meses";
                                                        } else {
                                                            echo " Mes";
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                   <label> <span>Horario de Atencion</span><br>
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                                        <div class="form-group">
                                                            <input type="text" name="dia1" class="form-control" placeholder=" Dia Ej: lunes " value="'.((isset($adv_data->first_schedule_attention)) ? $adv_data->first_schedule_attention : "").'">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <div class="col-md-6 col-sm-6 col-sm-12">
                                                            <div class="form-group">
                                                                <input type="time" name="hora1_desde" class="form-control" placeholder=" Ej: 09:30" value="'.((isset($adv_data->first_schedule_attention_from)) ? $adv_data->first_schedule_attention_from : "").'" max="23:59" min="00:00" step="1" >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-sm-12">
                                                            <div class="form-group">
                                                                <input type="time" name="hora1_hasta" class="form-control" placeholder="Ej:12:30"  value="'.((isset($adv_data->first_schedule_attention_to)) ? $adv_data->first_schedule_attention_to : "").'" max="23:59" min="00:00" step="1">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                                        <div class="form-group">
                                                            <input type="text" name="dia2" class="form-control" placeholder=" Dia Ej: Sabado " value="'.((isset($adv_data->second_schedule_attention)) ? $adv_data->second_schedule_attention : "").'">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <div class="col-md-6 col-sm-6 col-sm-12">
                                                            <div class="form-group">
                                                                <input type="time" name="hora2_desde" class="form-control" placeholder=" Ej: 09:30"  value="'.((isset($adv_data->second_schedule_attention)) ? $adv_data->second_schedule_attention_from : "").'" max="23:59" min="00:00" step="1">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-sm-12">
                                                            <div class="form-group">
                                                                <input type="time" name="hora2_hasta" class="form-control" placeholder="Ej:12:30"  value="'.((isset($adv_data->second_schedule_attention)) ? $adv_data->second_schedule_attention_to : "").'" max="23:59" min="00:00" step="1">
                                                            </div>
                                                        </div> 
                                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" placeholder="Detalle la descripción de su Publicación"><?php if(isset($adv_data->description)){echo $adv_data->description;} ?></textarea>
                                            </div>
                                ...
                                <div class="listing-title-area">
                                    <div class="row">
                                        <div class="col-md-12 <?php if(isset($_COOKIE['EDIT'])) { echo 'hidden';} ?>" >
                                            <div class="form-group">
                                                <label> <span>Imagenes de su Publicidad</span>
                                                </label><br>
                                    ...
                                    <div class="row p_t40">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                {
                                                    echo '<button type="submit" id ="new_ads" name="new_ads">Crear Publicación</button>';
                                                }
                                                ?>
