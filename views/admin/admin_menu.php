    ...
    <div class="profile-list">
        <ul>
            ...
            <li <?php if($_SESSION["admin_menu"] == "reviews"){ echo 'class="active"';} ?>>
                <a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/guia23/views/admin/revisiones_pendientes.php"><i class="fa fa-eye" aria-hidden="true"></i> Revisiones Pendientes <?php if(count($pendentsCounter) > 0){ echo '<span class="label label-warning"> '.count($pendentsCounter).' </span>';}?></a>
            </li>
            <?php
            if($_SESSION["role_id"] == 1)
            { ?>
