            ...
            ?>
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    ...
                    <div class="profile-login-bg">
                        <h2><span><i class="fa fa-industry"></i></span> <span>Comercios Pendientes (<?php echo count($pendentsCommerceCounter)?>) </span></h2>
...
//                                    var_dump($pendents);
                                    ...
                                    {
                                        echo "<tr>";
                                        echo "<td>$commerce->id</td>";
                                        echo "<td>$commerce->commerce_name</td>";
                                        echo "<td>$commerce->username</td>";
                                        echo "<td>$commerce->cat_name</td>";
                                        if($commerce->enabled == 1)
                                        {
                                            echo "<td><button class='btn btn-xs btn-warning' onclick='handle_commerce(" . $commerce->id . ",0)'>Deshabilitar</button></td>";
                                        }
                                        else
                                        {
