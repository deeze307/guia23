	...
	var style= [ 
	    ...
	    {	//poi stands no se muestra en el mapa
			featureType: "poi",
			elementType: "labels",
			stylers: [
				{visibility: "off"}
		...
		{
			//don't show highways labels en el mapa
		...
		{ 	
			//don't show calles locales en el mapa
		...
		{ 
			//don't show arteriaa en el mapa
	...
	//add custom buttons en zoom IN / OUT
	...
	var zoomControlDiv = document.createElement('div');
 	var zoomControl = new CustomZoomControl(zoomControlDiv, map);
  	...
  	//the zoom div en el margen izquierdo del mapa
